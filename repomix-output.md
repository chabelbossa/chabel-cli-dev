...
client/app/(auth)/sign-in/page.tsx
client/app/approve/page.tsx
client/app/device/page.tsx
...
server/.gitignore
server/package.json
server/prisma/migrations/20251104095426_authentication/migration.sql
server/prisma/migrations/20251106054258_conversation_model_added/migration.sql
server/prisma/migrations/migration_lock.toml
server/prisma/schema.prisma
server/repomix-output.md
server/src/cli/ai/google-service.js
server/src/cli/commands/ai/wakeUp.js
server/src/cli/commands/auth/login.js
server/src/cli/main.js
server/src/config/google.config.js
server/src/index.js
server/src/lib/auth-client.js
server/src/lib/auth.js
server/src/lib/db.js
server/src/services/chat.services.js
```

# Files

## File: server/prisma/migrations/20251106054258_conversation_model_added/migration.sql
````sql
-- CreateTable
...
## File: server/src/cli/ai/google-service.js
````javascript
import { google } from "@ai-sdk/google";
import { streamText } from "ai";
import { config } from "../config/google.config.js";
...
## File: server/src/cli/commands/ai/wakeUp.js
````javascript
import chalk from "chalk";
import { Command } from "commander";
import yoctoSpinner from "yocto-spinner";
...
const wakeUpAction = async () => {
  ...
  //! Pass token in fetchOptions headers
  const session = await auth.api.getSession({
    headers: {
      Authorization: `Bearer ${token.access_token}`,
    },
  ...
  spinner.stop();
    ...
    console.log(chalk.cyanBright(session));
...
## File: server/src/cli/commands/auth/login.js
````javascript
import { cancel, confirm, intro, isCancel, outro } from "@clack/prompts";
import { logger } from "better-auth";
import { createAuthClient } from "better-auth/client";
...
export async function whoamiAction(opts) {
  ...
  // The server-side session fetch
  const { data: session, error } = await auth.api.getSession({
  ...
  if (error || !session) {
    console.error("Failed to fetch session:", error?.message || "Unknown error");
    process.exit(1);
  }
...
## File: server/src/config/google.config.js
````javascript
import dotenv from 'dotenv';
dotenv.config();
...
## File: server/src/services/chat.services.js
````javascript
import {prisma} from "../lib/db.js"
import {auth} from "../lib/auth.js";
...
## File: client/app/(auth)/layout.tsx
````typescript
...
## File: client/app/(auth)/sign-in/page.tsx
````typescript
"use client"
...
## File: client/app/approve/page.tsx
````typescript
"use client";
...
## File: client/app/device/page.tsx
````typescript
"use client"
import { authClient } from "@/lib/auth-client";
import { useRouter } from "next/navigation";
...
## File: client/components/ui/alert.tsx
````typescript
import * as React from "react"
...
## File: client/components/ui/aspect-ratio.tsx
````typescript
"use client"
...
## File: client/components/ui/breadcrumb.tsx
````typescript
import * as React from "react"
import { Slot } from "@radix-ui/react-slot"
...
## File: client/components/ui/button-group.tsx
````typescript
import { Slot } from "@radix-ui/react-slot"
import { cva, type VariantProps } from "class-variance-authority"
...
## File: client/components/ui/calendar.tsx
````typescript
"use client"
...
## File: client/components/ui/chart.tsx
````typescript
"use client"
...
## File: client/components/ui/collapsible.tsx
````typescript
"use client"
...
## File: client/components/ui/empty.tsx
````typescript
import { cva, type VariantProps } from "class-variance-authority"
...
## File: client/components/ui/field.tsx
````typescript
"use client"
...
## File: client/components/ui/hover-card.tsx
````typescript
"use client"
...
## File: client/components/ui/input-group.tsx
````typescript
"use client"
...
## File: client/components/ui/input-otp.tsx
````typescript
"use client"
...
## File: client/components/ui/item.tsx
````typescript
import * as React from "react"
import { Slot } from "@radix-ui/react-slot"
import { cva, type VariantProps } from "class-variance-authority"
...
## File: client/components/ui/kbd.tsx
````typescript
import { cn } from "@/lib/utils"
...
## File: client/components/ui/popover.tsx
````typescript
"use client"
...
## File: client/components/ui/progress.tsx
````typescript
"use client"
...
## File: client/components/ui/resizable.tsx
````typescript
"use client"
...
## File: client/components/ui/slider.tsx
````typescript
"use client"
...
## File: client/components/ui/sonner.tsx
````typescript
"use client"
...
## File: client/components/ui/spinner.tsx
````typescript
...
## File: client/components/ui/toggle-group.tsx
````typescript
"use client"
...
## File: client/components/ui/toggle.tsx
````typescript
"use client"
...
## File: client/components/ui/tooltip.tsx
````typescript
"use client"
...
## File: client/hooks/use-mobile.ts
````typescript
import * as React from "react"
...
## File: client/lib/auth-client.ts
````typescript
...
## File: server/prisma/migrations/20251104095426_authentication/migration.sql
````sql
-- CreateTable
CREATE TABLE "user" (
    "id" TEXT NOT NULL,
...
app.get("/api/session/:access_token" , async (req, res) => {
...
## File: server/src/lib/auth-client.js
````javascript
import { deviceAuthorizationClient } from "better-auth/client/plugins"
import { createAuthClient } from "better-auth/client"
